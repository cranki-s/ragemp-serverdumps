...
var arenaSniper = 0;
var arenaHS = 0;
mp.events.add('actualizarJugadoresEquipos', (numeroCrips, numeroBloods, numeroFamilies, numeroCartelSinaloa, numeroZetas, numeroMarabunta, numeroArenaRevolver, numeroArenaBrawl, numeroArenaSniper, numeroArenaHeadshot) => {
    crips = numeroCrips;
    bloods = numeroBloods;
...
mp.events.add('render', () => {
  ...
  if(hudCef) {
    hudCef.execute(`updateGangs(${crips}, ${bloods}, ${marabunta}, ${families}, ${cartelSinaloa}, ${zetas}, ${arenaRevolver}, ${arenaBrawl}, ${arenaSniper}, ${arenaHS}, ${mp.players.length})`)
...
//KETBIND 'K' MUESTRA/CIERRA EL GANGS DEL HUD

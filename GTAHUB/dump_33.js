    ...
    function (e, t, s) {
      ...
      class l {
        ...
        Draw(e, t, s, i, n, h, o) {
          ...
          const r =
              1080 * (mp.game.resolution.width / mp.game.resolution.height),
            a = this.size.Width / r,
      ...
      class g extends d {
        ...
        Draw(e, t, s) {
          e || (e = new m(0, 0)),
            t ||
              s ||
              ((e = new u(this.pos.X + e.Width, this.pos.Y + e.Height)),
              (t = this.size),
              (s = this.color));
      ...
      class I {
        ...
        SetVerticalPosition(e) {
          (this._rectangle.pos = new u(this.Offset.X, e + 144 + this.Offset.Y)),
        ...
        Draw() {
          (this._rectangle.size = new m(431 + this.Parent.WidthOffset, 38)),
            ...
            (this._text.color = this.Enabled
              ...
              : new a(163, 159, 148)),
            this.LeftBadge != h.None
              ? ((this._text.pos = new u(35 + this.Offset.X, this._text.pos.Y)),
              ...
              : (this._text.pos = new u(8 + this.Offset.X, this._text.pos.Y)),
            this.RightBadge != h.None &&
              ((this._badgeRight.pos = new u(
      ...
      class T {
        constructor(e, t, s, i, n) {
          (this.counterPretext = ""),
            ...
            (this._background = new l(
              "commonmenu",
              "gradient_bgd",
              new u(this.offset.X, 144 + this.offset.Y - 37 + this.extraOffset),
              new m(290, 25)
            )),
        ...
        set CurrentSelection(e) {
          (this.MenuItems[this._activeItem % this.MenuItems.length].Selected =
            !1),
            (this._activeItem = 1e3 - (1e3 % this.MenuItems.length) + e),
        ...
        RecalculateDescriptionPosition() {
          ...
          e > this.MaxItemsOnScreen + 1 && (e = this.MaxItemsOnScreen + 2),
            (this._descriptionBar.pos = new u(
              this.offset.X,
        ...
        GoLeft() {
          if (
            ...
            if (this.MenuItems[this.CurrentSelection] instanceof M) {
              ...
              e.Index--,
                R.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                this.onListChange.emit(e, e.Index);
            } else if (this.MenuItems[this.CurrentSelection] instanceof O) {
              const e = this.MenuItems[this.CurrentSelection];
              (e.Index = e.Index - 1),
                R.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                this.onSliderChange.emit(e, e.Index, e.IndexToItem(e.Index));
            }
        }
        GoRight() {
          if (
        ...
        SelectItem() {
          if (!this.MenuItems[this.CurrentSelection].Enabled)
            return void R.PlaySound(this.AUDIO_ERROR, this.AUDIO_LIBRARY);
          const e = this.MenuItems[this.CurrentSelection];
        ...
        IsMouseInBounds(e, t) {
          ...
          return (
            s >= e.X && s <= e.X + t.Width && i > e.Y && i < e.Y + t.Height
          );
        }
        IsMouseInListItemArrows(e, t, s) {
          ...
          const h =
              5 +
              mp.game.invoke("0x85f061da64ed2f67".toUpperCase(), 0) * n * 0.35 +
              10,
            o = 431 - h;
        ...
        ProcessMouse() {
          ...
          this.MenuItems.length > this.MaxItemsOnScreen + 1 &&
            ...
            this.MouseEdgeEnabled
              ...
              : this.IsMouseInBounds(
                  new u(this.GetScreenResolutionMantainRatio().Width - 30, 0),
                  new m(30, 1080)
                ) && this.MouseEdgeEnabled
              ? (mp.game.cam.setGameplayCamRelativeHeading(
                  mp.game.cam.getGameplayCamRelativeHeading() - 5
              ...
              if (
                ...
                if (r.Selected && r.Enabled)
                    ...
                    switch (
                      ...
                      case 2:
                        ...
                        (null == s.Collection
                          ...
                          (s.Index++,
                          R.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                          this.onListChange.emit(s, s.Index));
                    }
                  ...
                  r.Selected
                    ? !r.Enabled &&
                      r.Selected &&
                      R.PlaySound(this.AUDIO_ERROR, this.AUDIO_LIBRARY)
          ...
          this.MenuItems.length <= this.MaxItemsOnScreen + 1 ||
            (this.IsMouseInBounds(
              ...
              ? ((this._extraRectangleUp.color = new a(30, 30, 30, 255)),
                (mp.game.controls.isControlJustPressed(0, 24) ||
                  mp.game.controls.isDisabledControlJustPressed(0, 24)) &&
                  (this.MenuItems.length > this.MaxItemsOnScreen + 1
                    ? this.GoUpOverflow()
            ...
            this.IsMouseInBounds(
              ...
              ? ((this._extraRectangleDown.color = new a(30, 30, 30, 255)),
                (mp.game.controls.isControlJustPressed(0, 24) ||
                  mp.game.controls.isDisabledControlJustPressed(0, 24)) &&
                  (this.MenuItems.length > this.MaxItemsOnScreen + 1
                    ? this.GoDownOverflow()
                    : this.GoDown()))
              : (this._extraRectangleDown.color = new a(0, 0, 0, 200)));
        }
        ProcessControl() {
          this.Visible &&
            (this._justOpened
            ...
            if (this.MenuItems.length <= this.MaxItemsOnScreen + 1) {
              ...
              if (
                ...
                if (this.counterOverride)
                  ...
                  const e =
                    this.CurrentSelection + 1 + " / " + this.MenuItems.length;

{
  ...
  (global.isPlayerFriend = function (a) {
    ...
    (global.isCharacterFriend = function (a) {
      return (
        !!(0 < global.adminLevel) || -1 != global.playerFriendsList.indexOf(a)
      );
    }),
    (global.playerFriendsReplaceString = function (a) {
      ...
      for (; null !== (b = c.exec(a)); ) {
        ...
        0 < global.adminLevel ||
        a == localPlayer.getVariable("characterId") ||
        -1 != global.playerFriendsList.indexOf(a)
          ? d.push([b[0], b[3]])
          : d.push([b[0], `Гражданин[${b[2]}]`]);
      }
    ...
    mp.events.add("client_playerFriends_remove", function (a) {
      const b = global.playerFriendsList.indexOf(a);
      -1 != b && global.playerFriendsList.splice(b, 1);
    }),

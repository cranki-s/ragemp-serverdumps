{
    const mp = global.mp,
        ...
        fishingPlaceListData = [{
            ...
            blipPosition: new mp.Vector3(1061.32, 7206.05, .1),
            difficult: 3,
            points: [
            ...
            blipPosition: new mp.Vector3(3918.13, 5295.08, .56),
            difficult: 3,
            points: [
                [new mp.Vector3(3918.13, 5295.08, .56), -1, 350]
            ]
        }, {
            blipPosition: [new mp.Vector3(4101.24, -5425.24, 0), new mp.Vector3(5680.85, -6196.54, 0), new mp.Vector3(4999.37, -3943.03, 0)],
            difficult: 4,
            points: [
                [new mp.Vector3(4840.571, -5174.425, 0), -1, 1500]
            ],
            check() {
                ...
                const {
                    ...
                    y: b,
                    z: c
                } = localPlayer.position, d = mp.game.gameplay.getGroundZFor3dCoord(a, b, c + 10, 0, !1);
                return !(0 < d) && -25 > d - c
            }
        }];
    ...
    fishingPlaceListData.forEach(a => {
        a.blipPosition && (Array.isArray(a.blipPosition) ? a.blipPosition.forEach(a => {
            mp.blips.new(68, a, {
                name: "\u0420\u044B\u0431\u0430\u043B\u043A\u0430",
                dimension: 0,
                drawDistance: 20,
            ...
            new global.TriggerColshape(b[0], 0, b[2], () => a.check ? (null != fishCheckInterval && clearInterval(fishCheckInterval), void(fishCheckInterval = setInterval(() => {
                const b = a.check();
                b && !fishPlaceIndexList.has(c) ? (fishPlaceIndexList.add(c), global.mainBrowser.call("cb:mainHud:statusIco:status", "fishing", !0)) : !b && fishPlaceIndexList.has(c) && (fishPlaceIndexList.delete(c), global.mainBrowser.call("cb:mainHud:statusIco:status", "fishing", !1))
            }, 100))) : void(0 == fishTriggerCounter && global.mainBrowser.call("cb:mainHud:statusIco:status", "fishing", !0), fishTriggerCounter++, fishPlaceIndexList.add(c)), () => a.check ? (null != fishCheckInterval && clearInterval(fishCheckInterval), fishCheckInterval = null, void(fishPlaceIndexList.has(c) && (fishPlaceIndexList.delete(c), global.mainBrowser.call("cb:mainHud:statusIco:status", "fishing", !1)))) : void(0 < fishTriggerCounter && (fishTriggerCounter--, fishPlaceIndexList.delete(c), 0 == fishTriggerCounter && global.mainBrowser.call("cb:mainHud:statusIco:status", "fishing", !1)))), fishPlaceIndexCounter++
        })
    }), mp.events.add("client_fishing", function (a, b) {
        const c = mp.players.atRemoteId(a);
        null == c || 0 === c.handle || (1 == b ? (mp.attachmentMngr.addClient(c, mp.game.joaat("fishingRod")), c.taskPlayAnim("amb@world_human_stand_fishing@base", "base", 1, 0, -1, 1, 1, !1, !1, !1)) : 2 == b ? c.taskPlayAnim("amb@world_human_stand_fishing@idle_a", "idle_b", 1, 0, -1, 1, 1, !1, !1, !1) : 3 == b ? (mp.attachmentMngr.removeFor(c, mp.game.joaat("fishingRod")), c.clearTasksImmediately()) : 0 == b && mp.attachmentMngr.removeFor(c, mp.game.joaat("fishingRod")))
    }), mp.events.add("client_fishing_taskStart", async function (a, b) {
        return 0 == fishPlaceIndexList.size ? void mp.api.notify.error("\u0422\u0443\u0442 \u043D\u0435\u043B\u044C\u0437\u044F \u0440\u044B\u0431\u0430\u0447\u0438\u0442\u044C") : localPlayer.isSwimming() || localPlayer.isSwimmingUnderWater() ? void mp.api.notify.error("\u041D\u0435\u043B\u044C\u0437\u044F \u0434\u0435\u043B\u0430\u0442\u044C \u044D\u0442\u043E \u0432 \u0432\u043E\u0434\u0435") : void mp.events.callRemote("server_fishing_start", [...fishPlaceIndexList][fishPlaceIndexList.size - 1], a, b)
    }), mp.events.add("client_fishing_startFishingGame", function (a, b) {
        mp.events.call("client_fishing", localPlayer.remoteId, 2), global.menuBrowser.execute(`startFishingGame(${a}, ${b});`), global.showCursor(!0), global.disableChatAndKeys(!0), global.discordUpdate("\u0420\u044B\u0431\u0430\u0447\u0438\u0442")
    }), mp.events.add("client_fishing_game_end", () => {
        mp.events.call("client_fishing", mp.players.local.remoteId, 3), global.showCursor(!1), global.disableChatAndKeys(!1), global.discordUpdate(), global.antiAFK_sendAction()
    }), mp.game.streaming.requestAnimDict("amb@world_human_stand_fishing@base"), mp.game.streaming.requestAnimDict("amb@world_human_stand_fishing@idle_a"), mp.attachmentMngr.register("fishingRod", "prop_fishing_rod_02", 60309, new mp.Vector3(.01, -.01, .03), new mp.Vector3(.1, 0, 0));
    const WORMS_POSITIONS = [new mp.Vector3(1910.83, 4745.17, 41.27), new mp.Vector3(1920.85, 4753.78, 41.58), new mp.Vector3(1932.79, 4763.01, 41.54), new mp.Vector3(1934.7, 4772.48, 41.77), new mp.Vector3(1924.41, 4763.43, 41.77), new mp.Vector3(1911.31, 4751.66, 41.48), new mp.Vector3(1899.91, 4753.07, 40.88), new mp.Vector3(1912.44, 4763.58, 41.86), new mp.Vector3(1925.76, 4775.6, 41.98), new mp.Vector3(1924.5, 4784.38, 42.47), new mp.Vector3(1912.71, 4774, 42.27), new mp.Vector3(1897.71, 4760.88, 41.45), new mp.Vector3(1881.87, 4779.75, 42.18), new mp.Vector3(1897.17, 4794.83, 43.52), new mp.Vector3(1893.61, 4807.54, 44.21), new mp.Vector3(1875.02, 4789.23, 42.76), new mp.Vector3(1855.69, 4800.55, 42.78), new mp.Vector3(1875.98, 4824.87, 44.39), new mp.Vector3(1848.36, 4808.65, 43.24)];
    mp.events.add("client_fishing_worms", () => {
        const a = WORMS_POSITIONS.map(a => mp.blips.new(1, a, {
            color: 1,
            dimension: 0,
            shortRange: !1,
            name: "?",
        ...
        }, 25e3), mp.api.notify.info("\u0422\u043E\u0447\u043A\u0438 \u043E\u0442\u043C\u0435\u0447\u0435\u043D\u044B \u043D\u0430 \u043A\u0430\u0440\u0442\u0435 25 \u0441\u0435\u043A\u0443\u043D\u0434")
    });
}
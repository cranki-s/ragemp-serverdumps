{
    const mp = global.mp,
        serverWorldObjectUsedMap = new Map;
    class ServerWorldObjectUsed {
        constructor(a, b) {
            this.id = parseInt(b[0]), this.actionColshape = new global.ActionColshape(a.position, a.dimension, parseInt(b[1]), b[2], () => {
                global.actionAntiFlood("server_serverWorldObjectUsed_use", 1500) && mp.events.callRemote("server_serverWorldObjectUsed_use", this.id)
    ...
    }, 9e3), mp.events.addDataHandler("_swo", (a, b) => {

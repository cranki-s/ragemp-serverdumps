{
    ...
    mp.events.add("client_jobs_skinDiver_start", function () {
        return isWorkStart ? void resetObjects() : void(isWorkStart = !0, localPlayer.setDiesInWater(!1), resetObjects())

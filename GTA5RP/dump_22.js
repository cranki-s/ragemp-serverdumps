{
    const mp = global.mp,
        marketCounterList = new Set,
        marketCounterMap = new Map;
    class MarketCounter {
        constructor(a, b) {
            this.id = a, this.mainObject = b, this.controlPickup = new global.ActionColshape(mp.game.object.getObjectOffsetFromCoords(this.mainObject.position.x, this.mainObject.position.y, this.mainObject.position.z, this.mainObject.rotation.z, 0, 1, 0), 0, 1, "\u0442\u043E\u0440\u0433\u043E\u0432\u0430\u0442\u044C", () => {
                mp.events.callRemote("server_market_contol", this.id)
            }), this.buyPickup = new global.ActionColshape(mp.game.object.getObjectOffsetFromCoords(this.mainObject.position.x, this.mainObject.position.y, this.mainObject.position.z, this.mainObject.rotation.z, 0, -1.5, 0), 0, 1, "\u043A\u0443\u043F\u0438\u0442\u044C \u043F\u0440\u0435\u0434\u043C\u0435\u0442\u044B", () => {
                ...
                return !1
            }, this.buyPickup.onceMode = !0, this.isDeleted = !1, marketCounterList.add(this), marketCounterMap.set(this.id, this)
        }
        destroy() {
            this.isDeleted || (this.isDeleted = !0, this.controlPickup.destroy(), this.buyPickup.destroy(), marketCounterList.delete(this), marketCounterMap.delete(this.id))
        }
    }
    let loadDataFirst = !1;
    setTimeout(() => {
    ...
    }, 5e3), mp.events.addDataHandler("_market", (a, b) => {
        ...
        if (d && 0 !== d.mainObject.handle) {
            ...
            try {
                ...
                for (let c = 0; c < b[3].length; c++) 0 >= b[3][c][0] ? a.setPropIndex(-1 * b[3][c][0], b[3][c][1], b[3][c][2], !0) : a.setComponentVariation(b[3][c][0], b[3][c][1], b[3][c][2], 2);
                0 >= b[0] ? a.setPropIndex(-1 * b[0], b[1], b[2][c], !0) : 8 == b[0] ? (a.setComponentVariation(8, a.getDrawableVariation(8), b[2][c], 2), a.setComponentVariation(11, b[5], b[2][c], 2)) : a.setComponentVariation(b[0], b[1], b[2][c], 2), setTimeout(() => {
                    switch (b[0]) {
                        case 6: {

{
  class Scaleform {
    constructor(a) {
      (this._handle = mp.game.graphics.requestScaleformMovie(a)),
    ...
    callFunction(a, ...b) {
      if (this.isLoaded && this.isValid) {
        ...
        c.pushScaleformMovieFunction(this._handle, a),
          b.forEach((a) => {
            switch (typeof a) {
              case "string": {
              ...
              case "number":
                +a === a && 0 != a % 1
                  ? c.pushScaleformMovieFunctionParameterFloat(a)
                  : c.pushScaleformMovieFunctionParameterInt(a);
            }
          }),
    ...
    render2D(a, b, c, d) {
      if ((this.onUpdate(), this.isLoaded && this.isValid)) {
        ...
        if (
          ...
          e.drawScaleformMovieFullscreen(this._handle, 255, 255, 255, 255, !1);
      }
    }
    render3D(a, b, c) {
      this.onUpdate(),

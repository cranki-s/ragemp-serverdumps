{
  const localPlayer = mp.players.local,
    createChinUpsTraining = ({ uId: a, position: b, heading: c }) => {
      mp.events.add("client_gym_playerStart", async (d, e) => {
        ...
        mp.players.exists(f) &&
          0 !== f.handle &&
          (await Promise.all([
            loadAnimDictAsync("amb@prop_human_muscle_chin_ups@male@enter"),
            loadAnimDictAsync("amb@prop_human_muscle_chin_ups@male@exit"),
            loadAnimDictAsync("amb@prop_human_muscle_chin_ups@male@idle_a"),
            loadAnimDictAsync("amb@prop_human_muscle_chin_ups@male@base"),
          ]),
          mp.players.exists(f) && 0 !== f.handle) &&
          (f.setCoordsNoOffset(b.x, b.y, b.z, !1, !1, !1),
          f.setHeading(c),
          f.clearTasksImmediately(),
          f.taskPlayAnim(
        ...
        new global.ActionColshape(
          ...
          () => {
            isGymGameStarted ||
              !tryStartTraining() ||
              (global.actionAntiFlood("server_gym_taskStart", 2500) &&
                mp.events.callRemote("server_gym_taskStart", a),
              global.notifyKeyHelpHide());
          }
        );
    },
    createSeatMuscleBench = ({ uId: a, position: b, heading: c }) => {
      mp.events.add("client_gym_playerStart", async (d, e, f) => {
        ...
        mp.players.exists(g) &&
          0 !== g.handle &&
          (await Promise.all([
            loadAnimDictAsync("amb@prop_human_seat_muscle_bench_press@base"),
            loadAnimDictAsync("amb@prop_human_seat_muscle_bench_press@idle_a"),
          ]),
          mp.players.exists(g) &&
            0 !== g.handle &&
            ...
            g.freezePosition(!0),
            g.setCollision(!1, !0),
            g.setCoordsNoOffset(b.x, b.y, b.z, !1, !1, !1),
            g.setHeading(c),
            g === mp.players.local
              ? ((gymGameTick = async (a) => {
                  g.taskPlayAnim(
            ...
            (g.__gymAttachedItem = mp.game.joaat("seatMuscleBenchLevel" + f)),
            mp.attachmentMngr.addClient(g, g.__gymAttachedItem)));
      }),
        mp.events.add("client_gym_playerEnd", async (b, c) => {
          if (b === a) {
            const a = mp.players.atRemoteId(c);
            mp.players.exists(a) &&
              0 !== a.handle &&
              (a.__gymAttachedItem &&
                (mp.attachmentMngr.removeFor(a, a.__gymAttachedItem),
                delete a.__gymAttachedItem),
              a.setCollision(!0, !1),
              a.freezePosition(!1),
  ...
  mp.attachmentMngr.register(
    ...
    mp.attachmentMngr.register(
      "seatMuscleBenchLevel5",
      "prop_barbell_100kg",
      28422,
      new mp.Vector3(0, 0, 0),
      new mp.Vector3(0, 0, 0)
    );
  const createMuscleFreeWeights = ({ uId: a, position: b, heading: c }) => {
    mp.events.add("client_gym_playerStart", async (d, e, f) => {
      if (d !== a) return;
      const g = mp.players.atRemoteId(e);
      mp.players.exists(g) &&
        ...
        mp.players.exists(g) &&
          ...
          (g.__gymAttachedItem = mp.game.joaat("muscleFreeWeightsLevel" + f)),
          mp.attachmentMngr.addClient(g, g.__gymAttachedItem)));
    }),
      mp.events.add("client_gym_playerEnd", async (b, c) => {
        if (b === a) {
  ...
  mp.attachmentMngr.register(
    ...
    mp.attachmentMngr.register(
      "muscleFreeWeightsLevel5",
      "prop_barbell_50kg",
      28422,
      new mp.Vector3(0, 0, -0.04),
      new mp.Vector3(0, 0, 0)
    );
  const createMuscleFreeWeightsHand = ({ uId: a, position: b }) => {
    mp.events.add("client_gym_playerStart", async (b, c, d) => {
      ...
      mp.players.exists(e) &&
        ...
        mp.players.exists(e) &&
          ...
          4 <= d
            ? ((e.__gymAttachedItem1 = mp.game.joaat(
                "muscleFreeWeightsHand3_1"
              )),
              mp.attachmentMngr.addClient(e, e.__gymAttachedItem1),
              (e.__gymAttachedItem2 = mp.game.joaat(
                "muscleFreeWeightsHand3_2"
              )),
              mp.attachmentMngr.addClient(e, e.__gymAttachedItem2))
            : 2 <= d
            ? ((e.__gymAttachedItem1 = mp.game.joaat(
                "muscleFreeWeightsHand2_1"
              )),
              mp.attachmentMngr.addClient(e, e.__gymAttachedItem1),
              (e.__gymAttachedItem2 = mp.game.joaat(
      ...
      mp.events.add("client_gym_playerEnd", async (b, c) => {
        if (b === a) {
          ...
          mp.players.exists(a) &&
            0 !== a.handle &&
            (a.__gymAttachedItem1 &&
              (mp.attachmentMngr.removeFor(a, a.__gymAttachedItem1),
              delete a.__gymAttachedItem1),
            a.__gymAttachedItem2 &&
              (mp.attachmentMngr.removeFor(a, a.__gymAttachedItem2),
              delete a.__gymAttachedItem2),
            a.clearTasksImmediately(),
            a === localPlayer && updateTimeout());
        }
      }),
  ...
  const createSeatMuscleBenchHand = ({ uId: a, position: b, heading: c }) => {
    mp.events.add("client_gym_playerStart", async (d, e, f) => {
      if (d !== a) return;
      const g = mp.players.atRemoteId(e);
      mp.players.exists(g) &&
        ...
        mp.players.exists(g) &&
          ...
          4 <= f
            ? ((g.__gymAttachedItem1 = mp.game.joaat(
                "muscleFreeWeightsHand3_1"
              )),
              mp.attachmentMngr.addClient(g, g.__gymAttachedItem1),
              (g.__gymAttachedItem2 = mp.game.joaat(
                "muscleFreeWeightsHand3_2"
              )),
              mp.attachmentMngr.addClient(g, g.__gymAttachedItem2))
            : 2 <= f
            ? ((g.__gymAttachedItem1 = mp.game.joaat(
                "muscleFreeWeightsHand2_1"
              )),
  ...
  const startGymGame = async () => {
    ...
    const a = localPlayer.getHealth(),
      { x: b, y: c, z: d } = localPlayer.position;
    let e = 25,
      f = !1,
      g = 0;
    const h = (a) => {
      0 === a ? (a = -5) : 1 === a ? (a = 5) : 2 == a && (a = 10),
        0 < a
          ? ((e += a),
            gymGameTick(100 <= e || 0 >= e),
            setTimeout(() => {
              f || ((f = 100 <= e || 0 >= e), !f && i());
            }, gymGameTickTime))
          : ((e += a),
    ...
    const i = () => {
        ...
        global.menuBrowser.execute(
          `startGymGame(${0.8 + Math.random()}, ${
            a(100 * Math.random()) + 350
          }, ${
            [0.25, 0.35, 0.45, 0.55][a(4 * Math.random())]
          }, '__client_gym_tick')`
        );
      },
      j = setInterval(() => {
        if (
          ...
          return (
            ...
            a - 5 > localPlayer.getHealth()
              ? mp.api.notify.error(
                  "\u041D\u0435\u043B\u044C\u0437\u044F \u0442\u0440\u0435\u043D\u0438\u0440\u043E\u0432\u0430\u0442\u044C\u0441\u044F \u043F\u0440\u0438 \u0441\u0438\u043B\u044C\u043D\u043E\u043C \u0433\u043E\u043B\u043E\u0434\u0435 \u0438\u043B\u0438 \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u0438 \u0443\u0440\u043E\u043D\u0430"
                )
              : 100 <= e
              ? mp.api.notify.success(
                  "\u041E\u0442\u043B\u0438\u0447\u043D\u044B\u0439 \u043F\u043E\u0434\u0445\u043E\u0434, \u0412\u044B \u0447\u0443\u0432\u0441\u0442\u0432\u0443\u0435\u0442\u0435 \u043F\u0440\u0438\u043B\u0438\u0432 \u0441\u0438\u043B"
                )
              : mp.api.notify.error(
                  "\u041D\u0435\u0443\u0434\u0430\u0447\u043D\u044B\u0439 \u043F\u043E\u0434\u0445\u043E\u0434, \u043E\u0442\u0434\u043E\u0445\u043D\u0438\u0442\u0435 \u0438 \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u0435\u0449\u0435 \u0440\u0430\u0437"
                ),
            mp.events.callRemote("server_gym_end", 100 <= e, g),
            mp.events.remove("__client_gym_tick", h),
            void clearInterval(j)
          );
      }, 100);
  ...
  const loadAnimDictAsync = async (a) => {
    if (!mp.game.streaming.hasAnimDictLoaded(a)) {
      ...
      while (!mp.game.streaming.hasAnimDictLoaded(a));
    }
  };
}

...
mp.events.add('CustomShape.NewShape', (obj)=>{
    ...
    if(shape == null){
        NewEvent.callRemote('CustomShape.ReportError', obj.pos.x, obj.pos.y, obj.pos.z);
        return;
    }
...
mp.events.add('playerEnterColshape', (shape)=>{
    if(shape.CustomUID!=null){
        NewEvent.callRemote('CustomShape.OnEnter', shape.CustomUID);
    }
});

mp.events.add('playerExitColshape', (shape)=>{
    if(shape.CustomUID!=null){
        NewEvent.callRemote('CustomShape.OnExit', shape.CustomUID);
    }
});

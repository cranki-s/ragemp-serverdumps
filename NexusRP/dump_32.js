...
mp.events.add('Controls-Business:SetNavigationTab', (route) => {
    NewEvent.callRemote('Controls-Business:SetNavigationTab',route);   
})
...
mp.events.add('Controls-Business:MoneyAction', (type, value) => {
    NewEvent.callRemote('Controls-Business:MoneyAction',type,value)
})
mp.events.add('Controls-Business:MarkupChange', (value) => {
    NewEvent.callRemote("Controls-Business:MarkupChange",value);
})
mp.events.add('Controls-Business:SellBusiness', () => {
    NewEvent.callRemote("Controls-Business:SellBusiness");

})
mp.events.add('Controls-Business:getOrder', (delivery, amount) => {
    NewEvent.callRemote('Controls-Business:getOrder',amount, delivery)
})

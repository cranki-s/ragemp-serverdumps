...
/*mp.events.addDataHandler('character_dimension', (entity, value, oldValue) => {
	if (mp.players.local == entity) {
		attachments = entity.__attachments;
		if (value) {
			attachments.forEach(attachment => {
				mp.attachmentMngr.removeFor(entity, attachment.id)
				mp.attachmentMngr.addFor(entity, attachment.id)
			})
		}
		else if (oldValue) {
			attachments.forEach(attachment => {

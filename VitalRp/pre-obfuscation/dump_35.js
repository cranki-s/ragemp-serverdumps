...
mp.keys.bind(0x26, false, function () { // стрелка вверх
...
mp.keys.bind(0x28, false, function () { // стрелка вверх
    //if (!loggedin || chatActive || editing || global.menuCheck() || cuffed || localplayer.getVariable('InDeath') == true || new Date().getTime() - lastCheck < 400) return;
    if(canDoBets){
...
mp.keys.bind(0x0D, false, function () { // стрелка вверх
    //if (!loggedin || chatActive || editing || global.menuCheck() || cuffed || localplayer.getVariable('InDeath') == true || new Date().getTime() - lastCheck < 400) return;
    if(canDoBets){
...
mp.keys.bind(0x20, false, function () { // стрелка вверх
    //if (!loggedin || chatActive || editing || global.menuCheck() || cuffed || localplayer.getVariable('InDeath') == true || new Date().getTime() - lastCheck < 400) return;
    if(canDoBets){

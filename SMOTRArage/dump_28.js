	...
	if(hud_browser) {
		if(fracPanel) {
			...
			if(typeof(localPlayer.getVariable("active.deal")) !== "undefined") {
				if(localPlayer.getVariable("active.deal")) return chatAPI.sysPush("<span style=\"color:#FF6146\"> * У Вас есть активная сделка, панель организации недоступна..</span>");
			}
			if(typeof(localPlayer.getVariable("player.blocks")) != "undefined") {
				let playerBlocks = localPlayer.getVariable("player.blocks");
				if(typeof(playerBlocks.jail) !== "undefined") return chatAPI.sysPush("<span style=\"color:#FF6146\"> * Панель организации (F2) в тюрьме не доступна..</span>");
			}
			let myFraction = {};
			if(typeof(localPlayer.getVariable("player.fraction")) !== "undefined") {
				if(localPlayer.getVariable("player.fraction")) {
					...
					if(typeof(myFraction.name) === "undefined") return chatAPI.sysPush("<span style=\"color:#FF6146\"> * Вы не состоите в организации, панель F2 недоступна..</span>");
				}
			}
			if(typeof(mp.world.data.fractions[myFraction.id]) === "undefined") return chatAPI.sysPush("<span style=\"color:#FF6146\"> * Ваша организация не инициализирована, панель F2 недоступна..</span>");
...
function successFractionMoneyWithdraw(fracName, fracColor, withdrawVal) {
	if(typeof(fracName) !== "undefined" && typeof(fracColor) !== "undefined" && typeof(withdrawVal) !== "undefined") {
		...
		if(fracPanel) closeFracMenu();
		chatAPI.warningPush(" * Списание средств <span style=\"color:#FEBC00\"><b>"+fracName+"</b></span>, вы списали<span style=\"color:#FEBC00\"><b>"+withdrawVal.replace(new RegExp(/(\d{1,3})(?=((\d{3})*)$)/g), ' $1')+"</b></span> руб.");
...
function imAcceptedInviteFraction(fracName, inviterNick, inviterID) {
	if(typeof(fracName) !== "undefined" && typeof(inviterNick) !== "undefined" && typeof(inviterID) !== "undefined") {
		if(fractionAction) fractionAction = false;
		chatAPI.warningPush(" * Вы вступили в <span style=\"color:#FEBC00\"><b>"+fracName+"</b></span>, пригласил <span style=\"color:#FEBC00\"><b>"+inviterNick+"</b></span> (<span style=\"color:#FEBC00\"><b>"+inviterID+"</b></span>)");
...
function fracAcceptionFailed(fracName, isAccepter, playerNick, playerID, reason) {
	if(typeof(fracName) !== "undefined" && typeof(isAccepter) !== "undefined" && typeof(playerNick) !== "undefined" && typeof(playerID) !== "undefined" && typeof(reason) !== "undefined") {
		if(fractionAction) fractionAction =	false;
		if(fracPanel) closeFracMenu();
		if(!isAccepter) chatAPI.warningPush(" * Вы не смогли принять <span style=\"color:#FEBC00\"><b>"+playerNick+"</b></span> (<span style=\"color:#FEBC00\"><b>"+playerID+")</b></span>");
		else chatAPI.warningPush(" * Вы не смогли вступить в <span style=\"color:#FEBC00\"><b>"+fracName+"</b></span>");
		chatAPI.warningPush(" * "+reason);
	}
}
...
function youAreKickedFromFraction(fracName, kickerNick, kickerID) {
	if(typeof(fracName) !== "undefined" && typeof(kickerNick) !== "undefined" && typeof(kickerID) !== "undefined") {
		...
		if(hud_browser) hud_browser.execute('fractionEnableWorkZones();');
		if(fracPanel) closeFracMenu();
		chatAPI.warningPush(" * Вы исключены из <span style=\"color:#FEBC00\"><b>"+fracName+"</b></span>, исключил <span style=\"color:#FEBC00\"><b>"+kickerNick+"</b></span> (<span style=\"color:#FEBC00\"><b>"+kickerID+"</b></span>)");
...
function youAreKickFromFraction(fracName, kickNick, kickID) {
	if(typeof(fracName) !== "undefined" && typeof(kickNick) !== "undefined" && typeof(kickID) !== "undefined") {
		...
		if(fracPanel) closeFracMenu();
		if(fractionAction) fractionAction = false;
		chatAPI.warningPush(" * Вы исключили из <span style=\"color:#FEBC00\"><b>"+fracName+"</b></span>, игрока <span style=\"color:#FEBC00\"><b>"+kickNick+"</b></span> (<span style=\"color:#FEBC00\"><b>"+kickID+"</b></span>)");
...
function youAreChangedRankFraction(fracName, changerNick, changerID, newRank, newRankTitle) {
	if(typeof(fracName) !== "undefined" && typeof(changerNick) !== "undefined" && typeof(changerID) !== "undefined" && typeof(newRank) !== "undefined" && typeof(newRankTitle) !== "undefined") {
		...
		if(hud_browser) hud_browser.execute('fractionEnableWorkZones();');
		if(fracPanel) closeFracMenu();
		chatAPI.warningPush(" * Ранг в <span style=\"color:#FEBC00\"><b>"+fracName+"</b></span> изменён на <span style=\"color:#FEBC00\"><b>"+newRankTitle+"</b></span> (<span style=\"color:#FEBC00\"><b>"+newRank+"</b></span>)");
		chatAPI.warningPush(" * Изменил ранг <span style=\"color:#FEBC00\"><b>"+changerNick+"</b></span> (<span style=\"color:#FEBC00\"><b>"+changerID+"</b></span>)");
...
function youAreChangeRankFraction(fracName, changeNick, changeID, newRank, newRankTitle) {
	if(typeof(fracName) !== "undefined" && typeof(changeNick) !== "undefined" && typeof(changeID) !== "undefined" && typeof(newRank) !== "undefined" && typeof(newRankTitle) !== "undefined") {
		...
		if(fracPanel) closeFracMenu();
		if(fractionAction) fractionAction = false;
		chatAPI.warningPush(" * Ранг изменён для <span style=\"color:#FEBC00\"><b>"+changeNick+"</b></span> (<span style=\"color:#FEBC00\"><b>"+changeID+"</b></span>)");
		chatAPI.warningPush(" * Новый ранг <span style=\"color:#FEBC00\"><b>"+newRankTitle+"</b></span> (<span style=\"color:#FEBC00\"><b>"+newRank+"</b></span>)");
...
function youAreLeaveFromFraction(fracName) {
	if(typeof(fracName) !== "undefined") {
		...
		if(fracPanel) closeFracMenu();
		if(fractionAction) fractionAction = false;
		chatAPI.warningPush(" * Вы успешно покинули <span style=\"color:#FEBC00\"><b>"+fracName+"</b></span>.");
...
function youAreChangeRanksFraction(fracName) {
	if(typeof(fracName) !== "undefined") {
		...
		if(fracPanel) closeFracMenu();
		if(fractionAction) fractionAction = false;
		chatAPI.warningPush(" * Новые настройки рангов для <span style=\"color:#FEBC00\"><b>"+fracName+"</b></span> установлены.");
...
function youAreChangeSpawnFraction(fracName) {
	if(typeof(fracName) !== "undefined") {
		...
		if(fracPanel) closeFracMenu();
		if(fractionAction) fractionAction = false;
		chatAPI.warningPush(" * Новый спаун для <span style=\"color:#FEBC00\"><b>"+fracName+"</b></span> установлен.");

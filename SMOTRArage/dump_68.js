...
let busZZ = mp.colshapes.newSphere(437.2815,-622.9944,28.7087,60,0);
let courRazgruzZZ = mp.colshapes.newSphere(150.5832,6431.6978,30.2988,60,0);
let courierZZ = mp.colshapes.newSphere(-46.3477,6381.605,30.8767,60,0);
...
mp.events.add('playerEnterColshape', (shape) => {
	if(typeof(shape) != "undefined") {
		if(mp.colshapes.exists(shape)) {
			if(shape == ekxZZ || shape == bolnicaZZ || shape == bolnicaSandyZZ || shape == bolnicaPaletoZZ || shape == taxiZZ || shape == wineryZZ || shape == truckZZ || shape == containersZZ || shape == busZZ || shape == courRazgruzZZ || shape == courierZZ) {
...
mp.events.add('playerExitColshape', (shape) => {
	if(typeof(shape) != "undefined") {
		if(mp.colshapes.exists(shape)) {
			if(shape == ekxZZ || shape == bolnicaZZ || shape == bolnicaSandyZZ || shape == bolnicaPaletoZZ || shape == taxiZZ || shape == wineryZZ || shape == truckZZ || shape == containersZZ || shape == busZZ || shape == courRazgruzZZ || shape == courierZZ) imInZZ = false;

...
mp.events.add('washProcess', () => {
    ...
    mp.gui.chat.push("Clerk says: Please wait inside your vehicle, while we wash your vehicle...");
    InitializeWaterParticles();
    setTimeout(() => {
        mp.gui.chat.push("!{#C2A2DA}* Cleaning brushes would rub along your vehicle *");
    }, 5000);
    setTimeout(() => {
        mp.gui.chat.push("Clerk says: Enjoy your cleaned vehicle!");

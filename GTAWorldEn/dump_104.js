    ...
    Assert(){
        ...
        this.m_Weapons.forEach(weapon => {
            ...
            if (getClipHash(WEAPON_DATA[weapon].name)){
                weaponData["CLIP_" + weapon] = "&nbsp;&nbsp;&nbsp;&nbsp;&#8594; Magazine (" + WEAPON_DATA[weapon].name + ")"
            }
            ...
            if (holsters){
                holsters.forEach(holster => {
                    weaponData["HOLSTER_" + weapon + "*" + "0x" + parseInt(holster.hash).toString(16).toUpperCase()] = "&nbsp;&nbsp;&nbsp;&nbsp;&#8594; Holster (" + holster.name + ")"
                })
            }
        })

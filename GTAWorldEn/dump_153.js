...
mp.events.add({
    ...
    // },
    'PropertyManager::savePermissions': (propertyID, constructionRights, propertyLocked) => {
        if(!IsManagerActive) return;
        mp.events.callRemote('PropertyManager::savePermissions', propertyID, constructionRights, propertyLocked);
    },

...
var CasinoPedss = [
    ...
    {Hash: 0x1422D45B, Pos: new mp.Vector3(1151.28,267.33,-51.840), Angle: 222.2},
    {Hash: 0xBC92BED5, Pos: new mp.Vector3(1128.853, 261.8036, -51.041), Angle: 314.2},
    {Hash: 0x1422D45B, Pos: new mp.Vector3(1143.875, 246.781, -51.041), Angle: 317.2},
];
...
setTimeout(function () {
    ...
    for(let tb = 0; tb < 4; tb++){
		...
		// BlackJackTables2[tb] = mp.objects.new(s_propName2, new mp.Vector3(BlackJackTablesPos[tb].x, BlackJackTablesPos[tb].y, BlackJackTablesPos[tb].z), {
            // rotation: new mp.Vector3(0, 0, BlackJackTablesHeading[tb]),
            // alpha: 255,
            // dimension: 0
        // });
...
mp.keys.bind(Keys.VK_DOWN, false, function () { // стрелка вверх
    if (!loggedin || chatActive || editing || global.menuCheck() || cuffed || localplayer.getVariable('InDeath') == true || new Date().getTime() - lastCheck < 400) return;
    if(canDoBets){

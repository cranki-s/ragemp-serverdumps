...
mp.events.add("toggleClothingMenu", () => {
...
let clothingMenuState = false;

mp.events.add('setClothingMenuState', () => {
    clothingMenuState = true;
});

mp.events.add('render', () => {
    if (clothingMenuState) {
        ...
        if (!menuRoupas.Visible && !menuRoupasMascaras.Visible && 
            ...
            !menuRoupasAcessorios.Visible && 
            !menuRoupasMochilas.Visible) {
            clothingMenuState = false;
            mp.events.call('setOutfitEditorState', false);
            if (sharedVariables.setFFASelectionActive) {
                mp.events.call("enterFFA");
                mp.events.call("setFFAHandler");
            }
            if (sharedVariables.setArenaSelectionActive) {
                mp.events.call("enterArena");
                mp.events.call("setArenaHandler");
            }
        }
    }
});

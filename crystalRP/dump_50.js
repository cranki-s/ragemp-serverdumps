{
let wheel = mp.objects.new(mp.game.joaat('vw_prop_vw_luckywheel_02a'), new mp.Vector3(1111.05, 229.81, -49.15), { dimension: 0 });
wheel.setHeading(-30);
...
let podium = mp.objects.new(2733879850, new mp.Vector3(1100.0177001953125, 220.02122497558594, -49.989967346191406), { dimension: 1 });

let veh = mp.vehicles.new(mp.game.joaat("xc90"), new mp.Vector3(1100.0177001953125, 220.02122497558594, -48.789967346191406),
{

...
mp.events.add('CarrySystem::SyncDetachCarryPair', function (remoteIDCarrier, remoteIDCarried) {
    ...
    if (carrier !== undefined && carrier !== null && carrier.doesExist()) {
        ...
        groundLevel = mp.game.gameplay.getGroundZFor3dCoord(carrier.position.x, carrier.position.y, carrier.position.z, 0.0, false);
    }
    ...
    if (carried !== undefined && carried !== null && carried.doesExist()) {
        ...
        if (groundLevel == 0.0) {
            groundLevel = mp.game.gameplay.getGroundZFor3dCoord(carried.position.x, carried.position.y, carried.position.z, 0.0, false);
        }
...
},{"../utilities/globals":13}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../tooltip/TooltipHandler":8,"../utilities/eventswrapper":12,"../utilities/globals":13,"../utilities/raycaster":14}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../utilities/enums":11}],4:[function(require,module,exports){
"use strict";
...
},{"./carry/carryscript":1,"./clicktowalk/ClickToWalkHandler":2,"./doorunlocker/doorunlocker":3,"./queue/queue":5,"./recoil/recoil":6,"./sandbox/sandbox":7,"./tooltip/TooltipHandler":8,"./twofactor/twofactor":9}],5:[function(require,module,exports){
"use strict";
var debugMode = false;
...
},{"../utilities/enums":11,"../utilities/eventswrapper":12,"../utilities/globals":13}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../utilities/enums":11,"../utilities/eventswrapper":12,"../utilities/globals":13,"../utilities/raycaster":14}],8:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../clicktowalk/ClickToWalkHandler":2,"../utilities/datarequests":10,"../utilities/eventswrapper":12,"../utilities/globals":13,"../utilities/raycaster":14,"../utilities/tooltipmenu":15}],9:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../utilities/globals":13}],10:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"./eventswrapper":12}],15:[function(require,module,exports){
"use strict";

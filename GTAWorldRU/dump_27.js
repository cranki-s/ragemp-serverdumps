...
mp.events.add('confirmedGender', (pickedFemale, randomize) => {
    ...
    if(CCBrowsers.genderPicker != null){
...
mp.events.add('clientSideSliderInput', (menuItem, value) => {
    ...
    switch (menuItem) {
        ...
        case 'skintoneblend':
            ...
            mp.events.callRemote(tracker[menuItem].eventName, tracker['faceone'].value, tracker['facetwo'].value, tracker['faceblend'].value, tracker['skintoneblend'].value);
            break;
...
mp.events.add( 'finishBarberCreation', ( tats = [], toOutfit = -1 ) => {
    ...
    if( inCreation )
    {
        //this fixes "`index` is out of rane" exception

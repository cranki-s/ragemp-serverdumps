...
function closeAllMenus() {
    char_barber_menu.Close();
    char_barber_menu_secondary.Close();
    char_clothes_menu.Close();
    char_clothes_menu_secondary.Close();
    char_surgery_menu.Close();
    char_surgery_menu_secondary.Close();
    char_tattoo_menu.Close();
    char_tattoo_menu_secondary.Close();
    char_cop_menu.Close();
    char_clothes_menu_secondary.Close();
    char_wardrobe_menu.Close();
    char_uniform_menu.Close();
    char_skin_menu.Close();
    char_cop_menu_secondary.Close();
    creation_skin_menu.Close();
    creation_clothes_menu.Close();
    creation_clothes_menu_secondary.Close();
    creation_surgery_menu.Close();
    creation_surgery_menu_secondary.Close();
    creation_barber_menu.Close();
    creation_barber_menu_secondary.Close();
    char_mask_menu.Close();
}
...
function initiateMenus()
{
    ...
    char_tattoo_menu = new Menu("Макияж", "Выберите макияж", new Point(posX, posY));
    ...
    char_wardrobe_menu = new Menu("Выбор образа", "", new Point(posX, posY));
    char_uniform_menu = new Menu("Выбор униформы", "", new Point(posX, posY));

    char_skin_menu = new Menu("Пол", "Меню выбора пола", new Point(posX, posY));
...
//char_clothes_menu.AddItem(new UIMenuItem("Accessories 2", ""));
    ...
    char_clothes_menu.AddItem(new UIMenuListItem("~g~Приобрести для этого образа", "Цена: $100", new ItemsCollection(wardrobe_names, 0)));
    char_clothes_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, 0)));
    char_clothes_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
    ...
    creation_clothes_menu.AddItem(new UIMenuItem("~g~Подтвердить", ""));
    creation_clothes_menu.RefreshIndex();

    char_cop_menu.AddItem(new UIMenuItem("~y~Default Male Cop Outfit", "Только GTAO персонажи"));
    char_cop_menu.AddItem(new UIMenuItem("~y~Default Female Cop Outfit", "Только GTAO персонажи"));
    char_cop_menu.AddItem(new UIMenuItem("~y~Default Male Sheriff Outfit", "Только GTAO персонажи"));
    char_cop_menu.AddItem(new UIMenuItem("~y~Default Female Sheriff Outfit", "Только GTAO персонажи"));
...
//char_cop_menu.AddItem(new UIMenuItem("Accessories 2", ""));
    ...
    char_cop_menu.AddItem(new UIMenuListItem("~g~Select Uniform", "Выбор слота", new ItemsCollection(uniform_names, 0)));
    char_cop_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
    char_cop_menu.RefreshIndex();

//char_surgery_menu.AddItem(new UIMenuItem("Head", "Non-GTAO"));
    char_surgery_menu.AddItem(new UIMenuListItem("Head Blend 1", "GTAO Only Head Model", new ItemsCollection(convertValueToList(46), 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Head Blend 2", "GTAO Only Head Model", new ItemsCollection(convertValueToList(46), 0)));
    ...
    char_surgery_menu.AddItem(new UIMenuListItem("Eye Color", "Только GTAO персонажи", new ItemsCollection(convertValueToList(32), 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Nose Width", "Только GTAO персонажи", new ItemsCollection(listNoseWidth, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Nose Vertical", "Только GTAO персонажи", new ItemsCollection(listNoseVertical, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Nose Horizontal", "Только GTAO персонажи", new ItemsCollection(listNoseHorizontal, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Nose Curve", "Только GTAO персонажи", new ItemsCollection(listNoseCurve, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Nose Point", "Только GTAO персонажи", new ItemsCollection(listNosePoint, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Nose Bend", "Только GTAO персонажи", new ItemsCollection(listNoseBend, 100)));
    char_surgery_menu.AddItem(new UIMenuListItem("Eyebrow Vertical", "Только GTAO персонажи", new ItemsCollection(listEyebrowVertical, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Eyebrow Horizontal", "Только GTAO персонажи", new ItemsCollection(listEyebrowHorizontal, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Malar Vertical", "Только GTAO персонажи", new ItemsCollection(listMalarVertical, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Malar Horizontal", "Только GTAO персонажи", new ItemsCollection(listMalarHorizontal, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Cheekbone Depth", "Только GTAO персонажи", new ItemsCollection(listCheekboneDepth, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Squint", "Только GTAO персонажи", new ItemsCollection(listSquint, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Lip Size", "Только GTAO персонажи", new ItemsCollection(listLipSize, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Jawline Vertical", "Только GTAO персонажи", new ItemsCollection(listJawlineVertical, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Jawline Horizontal", "Только GTAO персонажи", new ItemsCollection(listJawlineHorizontal, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Chin Size", "Только GTAO персонажи", new ItemsCollection(listChinSize, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Chin Length", "Только GTAO персонажи", new ItemsCollection(listChinLength, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Chin Width", "Только GTAO персонажи", new ItemsCollection(listChinWidth, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("Chin Indent", "Только GTAO персонажи", new ItemsCollection(listChinIndent, 0)));
    char_surgery_menu.AddItem(new UIMenuItem("Blemishes", "Только GTAO персонажи"));
    char_surgery_menu.AddItem(new UIMenuItem("Ageing", "Только GTAO персонажи"));
    char_surgery_menu.AddItem(new UIMenuItem("Complexion", "Только GTAO персонажи"));
    char_surgery_menu.AddItem(new UIMenuItem("Sun Damage", "Только GTAO персонажи"));
    char_surgery_menu.AddItem(new UIMenuItem("Moles/Freckles", "Только GTAO персонажи"));
    char_surgery_menu.AddItem(new UIMenuItem("Body Blemishes", "Только GTAO персонажи"));
    char_surgery_menu.AddItem(new UIMenuItem("Add Body Blemishes", "Только GTAO персонажи"));
    char_surgery_menu.AddItem(new UIMenuItem("~g~Приобрести для всех образов", "Цена: $300"));
    char_surgery_menu.AddItem(new UIMenuListItem("~g~Приобрести для этого образа", "Цена: $300", new ItemsCollection(wardrobe_names, 0)));
    char_surgery_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, 0)));
    char_surgery_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
...
//creation_surgery_menu.AddItem(new UIMenuItem("Beard", "")); Mask, no idea why
    creation_surgery_menu.AddItem(new UIMenuListItem("Head Blend 1", "GTAO Only Head Model", new ItemsCollection(convertValueToList(46), 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Head Blend 2", "GTAO Only Head Model", new ItemsCollection(convertValueToList(46), 0)));
    ...
    creation_surgery_menu.AddItem(new UIMenuListItem("Eye Color", "Только GTAO персонажи", new ItemsCollection(convertValueToList(32), 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Nose Width", "Только GTAO персонажи", new ItemsCollection(listNoseWidth, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Nose Vertical", "Только GTAO персонажи", new ItemsCollection(listNoseVertical, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Nose Horizontal", "Только GTAO персонажи", new ItemsCollection(listNoseHorizontal, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Nose Curve", "Только GTAO персонажи", new ItemsCollection(listNoseCurve, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Nose Point", "Только GTAO персонажи", new ItemsCollection(listNosePoint, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Nose Bend", "Только GTAO персонажи", new ItemsCollection(listNoseBend, 100)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Eyebrow Vertical", "Только GTAO персонажи", new ItemsCollection(listEyebrowVertical, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Eyebrow Horizontal", "Только GTAO персонажи", new ItemsCollection(listEyebrowHorizontal, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Malar Vertical", "Только GTAO персонажи", new ItemsCollection(listMalarVertical, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Malar Horizontal", "Только GTAO персонажи", new ItemsCollection(listMalarHorizontal, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Cheekbone Depth", "Только GTAO персонажи", new ItemsCollection(listCheekboneDepth, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Squint", "Только GTAO персонажи", new ItemsCollection(listSquint, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Lip Size", "Только GTAO персонажи", new ItemsCollection(listLipSize, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Jawline Vertical", "Только GTAO персонажи", new ItemsCollection(listJawlineVertical, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Jawline Horizontal", "Только GTAO персонажи", new ItemsCollection(listJawlineHorizontal, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Chin Size", "Только GTAO персонажи", new ItemsCollection(listChinSize, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Chin Length", "Только GTAO персонажи", new ItemsCollection(listChinLength, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Chin Width", "Только GTAO персонажи", new ItemsCollection(listChinWidth, 0)));
    creation_surgery_menu.AddItem(new UIMenuListItem("Chin Indent", "Только GTAO персонажи", new ItemsCollection(listChinIndent, 0)));
    creation_surgery_menu.AddItem(new UIMenuItem("Blemishes", "Только GTAO персонажи"));
    creation_surgery_menu.AddItem(new UIMenuItem("Ageing", "Только GTAO персонажи"));
    creation_surgery_menu.AddItem(new UIMenuItem("Complexion", "Только GTAO персонажи"));
    creation_surgery_menu.AddItem(new UIMenuItem("Sun Damage", "Только GTAO персонажи"));
    creation_surgery_menu.AddItem(new UIMenuItem("Moles/Freckles", "Только GTAO персонажи"));
    creation_surgery_menu.AddItem(new UIMenuItem("Body Blemishes", "Только GTAO персонажи"));
    creation_surgery_menu.AddItem(new UIMenuItem("Add Body Blemishes", "Только GTAO персонажи"));
    creation_surgery_menu.AddItem(new UIMenuItem("~g~Подтвердить", ""));
    creation_surgery_menu.RefreshIndex();

    char_tattoo_menu.AddItem(new UIMenuItem("Макияж", "Только GTAO персонажи"));
    char_tattoo_menu.AddItem(new UIMenuItem("Румянец", "Только GTAO персонажи"));
    char_tattoo_menu.AddItem(new UIMenuItem("Помада", "Только GTAO персонажи"));
    char_tattoo_menu.AddItem(new UIMenuItem("~g~Приобрести для всех образов", "Цена: $100"));
    char_tattoo_menu.AddItem(new UIMenuListItem("~g~Приобрести для этого образа", "Цена: $100", new ItemsCollection(wardrobe_names, 0)));
    char_tattoo_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, 0)));
    char_tattoo_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
    char_tattoo_menu.RefreshIndex();

    char_wardrobe_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, 0)));
    char_wardrobe_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
    char_wardrobe_menu.RefreshIndex();

    char_uniform_menu.AddItem(new UIMenuListItem("~g~Выбрать униформу", "Выбор слота", new ItemsCollection(uniform_names, 0)));
    char_uniform_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
    char_uniform_menu.RefreshIndex();

    char_barber_menu.AddItem(new UIMenuItem("Hair", "Причёска"));
    char_barber_menu.AddItem(new UIMenuItem("Facial Hair", "Только GTAO персонажи"));
    char_barber_menu.AddItem(new UIMenuItem("Chest Hair", "Только GTAO персонажи"));
    char_barber_menu.AddItem(new UIMenuItem("Eyebrows", "Только GTAO персонажи"));
    char_barber_menu.AddItem(new UIMenuItem("~g~Приобрести для всех образов", "Цена: $100"));
    char_barber_menu.AddItem(new UIMenuListItem("~g~Приобрести для этого образа", "Цена: $100", new ItemsCollection(wardrobe_names, 0)));
    char_barber_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, 0)));
    char_barber_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
    char_barber_menu.RefreshIndex();

    creation_barber_menu.AddItem(new UIMenuItem("Hair", "Причёска"));
    creation_barber_menu.AddItem(new UIMenuItem("Facial Hair", "Только GTAO персонажи"));
    creation_barber_menu.AddItem(new UIMenuItem("Chest Hair", "Только GTAO персонажи"));
    creation_barber_menu.AddItem(new UIMenuItem("Eyebrows", "Только GTAO персонажи"));
    creation_barber_menu.AddItem(new UIMenuItem("~g~Подтвердить", ""));
...
function onItemSelectCopSecondary(item, index) {
    if (item.Text === "~r~Выход") {
        char_cop_menu.Visible = true;
        char_cop_menu_secondary.Visible = false;
    }
    else if (item.Text === "Отменить") {
...
function onItemSelectCreationSkin(item, index) {
    if (item.Text === "~g~Стандартный скин") {
...
function onItemSelectSkinMain(item, index) {
    ...
    else if (item.Text === "~g~Купить") {
        mp.events.callRemote("purchase_skin", item.Index);
        char_skin_menu.Close();
        mp.game.cam.renderScriptCams(false, false, 0, true, false);
        mp.events.callRemote("unfreeze_clothes_player");
    }
    else if (item.Text == "~y~Мужской пол") {
        mp.events.callRemote("purchase_male_skin");
        char_skin_menu.Close();
        mp.game.cam.renderScriptCams(false, false, 0, true, false);
        mp.events.callRemote("unfreeze_clothes_player");
    }
    else if (item.Text == "~y~Женский пол") {
...
function onItemSelectCopMain(item, index) {
    ...
    else if (item.Text === "Головной Убор") {
...
function listChangeEventCopMain(item, index) {
    if (item.Text === "~g~Сохранить форму") {
...
function listChangeEventCopSecondary(item, index) {
    if (item.Text === "Drawable Var") {
        ...
        char_cop_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
...
function onItemSelectTattooMain(item, index) {
    if (item.Text === "Макияж") {
        ...
        char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Макияж", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(4)), 0))); //_GET_NUM_HEAD_OVERLAY_VALUES
        char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100), startIndex = 100));
        //char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Color", "Цветовые коды", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(4)), 0))); //_GET_NUM_MAKEUP_COLORS
        //char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Color2", "Цветовые коды", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(4)), 0)));
        char_tattoo_menu_secondary.AddItem(new UIMenuItem("Убрать", "Remove makeup."));
        char_tattoo_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_tattoo_menu_secondary.RefreshIndex();
        char_tattoo_menu_secondary.Visible = true;
    }
    else if (item.Text === "Румянец") {
        tracker_blush_opacity = 100;
        char_tattoo_menu.Visible = false;
        char_tattoo_menu_secondary.Clear();
        char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Румянец", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(5)), 0)));
        char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100), startIndex = 100));
        char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Цвет", "Цветовые коды", new ItemsCollection(convertValueToList(63), 0)));
        //char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Color2", "Цветовые коды", new ItemsCollection(convertValueToList(63), 0)));
        char_tattoo_menu_secondary.AddItem(new UIMenuItem("Убрать", "Remove blush."));
        char_tattoo_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_tattoo_menu_secondary.RefreshIndex();
        char_tattoo_menu_secondary.Visible = true;
    }
    else if (item.Text === "Помада") {
        tracker_lipstick_opacity = 100;
        char_tattoo_menu.Visible = false;
        char_tattoo_menu_secondary.Clear();
        char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Помада", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(8)), 0)));
        char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100), startIndex = 100));
        char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Цвет", "Цветовые коды", new ItemsCollection(convertValueToList(63), 0)));
        //char_tattoo_menu_secondary.AddItem(new UIMenuListItem("Color2", "Цветовые коды", new ItemsCollection(convertValueToList(63), 0)));
        char_tattoo_menu_secondary.AddItem(new UIMenuItem("Убрать", "Убрать помаду"));
        char_tattoo_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_tattoo_menu_secondary.RefreshIndex();
        char_tattoo_menu_secondary.Visible = true;
    }
    else if (item.Text === "~g~Приобрести для этого образа") {
        //save here clothes
        var data = [];
    ...
    else if (item.Text === "~g~Приобрести для всех образов") {
        //save here clothes
        var data = [];
        data.push(tracker_makeup);
        data.push(tracker_makeup_color);
...
function listChangeEventTattooSecondary(item, index) {
    ...
    else if (item.Text === "Сила" || item.Text === "Сила") {
...
function onItemSelectTattooSecondary(item, index) {
    ...
    else if (item.Text === "Remove" || item.Text === "Убрать") {
        if (tracker_facial_feat === 4) {
...
mp.events.add( 'do_barber_creation_end', () => {
    mp.events.call( 'OUTFITSHOP::SHOW', false, true, 0, true );
...
function onItemSelectCreationBarberMain(item, index) {
    ...
    else if (item.Text === "Борода и усы") {
        creation_barber_menu.Visible = false;
        creation_barber_menu_secondary.Clear();
        creation_barber_menu_secondary.AddItem(new UIMenuListItem("Борода и усы", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(1)), 0)));
        creation_barber_menu_secondary.AddItem(new UIMenuListItem("Сила", "Видимость от 0 до 100.", new ItemsCollection(convertValueToList(101), 100)));
        creation_barber_menu_secondary.AddItem(new UIMenuListItem("Цвет", "Цветовые коды", new ItemsCollection(convertValueToList(63), 0)));
        creation_barber_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_barber_menu_secondary.RefreshIndex();
        creation_barber_menu_secondary.Visible = true;
    }
    else if (item.Text === "Брови") {
        creation_barber_menu.Visible = false;
        creation_barber_menu_secondary.Clear();
        creation_barber_menu_secondary.AddItem(new UIMenuListItem("Брови", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(2)), 0)));
        creation_barber_menu_secondary.AddItem(new UIMenuListItem("Сила", "Видимость от 0 до 100.", new ItemsCollection(convertValueToList(101), 100)));
        creation_barber_menu_secondary.AddItem(new UIMenuListItem("Цвет", "Цветовые коды", new ItemsCollection(convertValueToList(63), 0)));
        creation_barber_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_barber_menu_secondary.RefreshIndex();
    ...
    else if (item.Text === "Волосы на теле") {
        creation_barber_menu.Visible = false;
        creation_barber_menu_secondary.Clear();
        creation_barber_menu_secondary.AddItem(new UIMenuListItem("Волосы на теле", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(10)), 0)));
        creation_barber_menu_secondary.AddItem(new UIMenuListItem("Сила", "Видимость от 0 до 100.", new ItemsCollection(convertValueToList(101), 100)));
        creation_barber_menu_secondary.AddItem(new UIMenuListItem("Цвет", "Цветовые коды", new ItemsCollection(convertValueToList(32), 0)));
        creation_barber_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_barber_menu_secondary.RefreshIndex();
        creation_barber_menu_secondary.Visible = true;
    }
...
function onItemSelectBarberMain(item, index) {
    if (item.Text === "~g~Купить") {
    ...
    else if (item.Text === "~g~Купить все") {
    ...
    else if (item.Text === "Причёская") {
        tracker_component = 2;
        var drawVariantCount = mp.players.local.getNumberOfDrawableVariations( 2);
        mp.events.callRemote("fetch_hair_data", drawVariantCount);
        char_barber_menu.Visible = false;
    }
    else if (item.Text === "Татуаж волос") {
        char_barber_menu.Visible = false;
        ...
        char_barber_menu_secondary.AddItem(new UIMenuItem("Добавить", "Добавляет текущий татуаж волос в ваш список желаемого."));
        char_barber_menu_secondary.AddItem(new UIMenuItem("Убрать", "Убирает текущий татуаж волос из вашего списка желаемого."));
        char_barber_menu_secondary.AddItem(new UIMenuItem("Очистить", "Resets the wanted list."));
        char_barber_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Finalize hair tattoo modifications"));
        ...
        char_barber_menu.Visible = false;
        char_barber_menu_secondary.Clear();
        char_barber_menu_secondary.AddItem(new UIMenuListItem("Борода и Усы", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(1)), 0)));
        char_barber_menu_secondary.AddItem(new UIMenuListItem("Сила", "Видимость от 0 до 100.", new ItemsCollection(convertValueToList(101), 100)));
        char_barber_menu_secondary.AddItem(new UIMenuListItem("Цвет", "Цветовые коды", new ItemsCollection(convertValueToList(63), 0)));
        char_barber_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_barber_menu_secondary.RefreshIndex();
        ...
        char_barber_menu.Visible = false;
        char_barber_menu_secondary.Clear();
        char_barber_menu_secondary.AddItem(new UIMenuListItem("Брови", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(2)), 0)));
        char_barber_menu_secondary.AddItem(new UIMenuListItem("Сила", "Видимость от 0 до 100.", new ItemsCollection(convertValueToList(101), 100)));
        char_barber_menu_secondary.AddItem(new UIMenuListItem("Цвет", "Цветовые коды", new ItemsCollection(convertValueToList(63), 0)));
        char_barber_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_barber_menu_secondary.RefreshIndex();
        ...
        char_barber_menu.Visible = false;
        char_barber_menu_secondary.Clear();
        char_barber_menu_secondary.AddItem(new UIMenuListItem("Волосы на теле", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(10)), 0)));
        char_barber_menu_secondary.AddItem(new UIMenuListItem("Сила", "Видимость от 0 до 100.", new ItemsCollection(convertValueToList(101), 100)));
        char_barber_menu_secondary.AddItem(new UIMenuListItem("Цвет", "Цветовые коды", new ItemsCollection(convertValueToList(32), 0)));
        char_barber_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_barber_menu_secondary.RefreshIndex();
        char_barber_menu_secondary.Visible = true;
    }
...
function listChangeEventSurgeryCreationMain(item, index) {
    if (item.Text === "Head Blend 1") {
        tracker_blend_1 = item.Index;
        mp.events.callRemote("apply_head_blend", tracker_blend_1, tracker_blend_2, tracker_blend_mix, tracker_skin_mix);
    }
    else if (item.Text === "~g~Подтвердить") {
        tracker_save_slot = item.Index;
        //creation_clothes_menu.Visible = true;
        creation_surgery_menu.Close();
        mp.events.callRemote("play_anim", "friskstance");
    }
    else if (item.Text === "Head Blend 2") {
...
function listChangeEventClothesMain(item, index) {
    if (item.Text === "~g~Приобрести для этого образа") {
        tracker_save_slot = item.Index;
    }
    else if (item.Text === "~g~Выбрать образ") {
        tracker_save_slot = item.Index;
...
function listChangeEventCreationClothesSecondary(item, index) {
    if (item.Text === "Drawable Var") {
        ...
        creation_clothes_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
...
function listChangeEventClothesSecondary(item, index) {
    if (item.Text === "Drawable Var") {
        ...
        char_clothes_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
...
function listChangeEventSurgeryCreationSecondary(item, index) {
    if (item.Text === "Blemishes") {
        ...
        creation_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
...
function onItemSelectSurgeryCreationMain(item, index) {
    if (item.Text === "Head") {
        ...
        creation_surgery_menu.Close();
        creation_surgery_menu_secondary.Clear();
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Blemishes", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(0)), 0)));
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        creation_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_surgery_menu_secondary.RefreshIndex();
        ...
        creation_surgery_menu.Close();
        creation_surgery_menu_secondary.Clear();
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Ageing", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(3)), 0)));
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        creation_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_surgery_menu_secondary.RefreshIndex();
        creation_surgery_menu_secondary.Visible = true;
        ...
        creation_surgery_menu.Close();
        creation_surgery_menu_secondary.Clear();
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Complexion", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(6)), 0)));
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        creation_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_surgery_menu_secondary.RefreshIndex();
        creation_surgery_menu_secondary.Visible = true;
        ...
        creation_surgery_menu.Close();
        creation_surgery_menu_secondary.Clear();
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Sun Damage", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(7)), 0)));
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        creation_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_surgery_menu_secondary.RefreshIndex();
        creation_surgery_menu_secondary.Visible = true;
        ...
        creation_surgery_menu.Close();
        creation_surgery_menu_secondary.Clear();
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Moles/Freckles", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(9)), 0)));
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        creation_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_surgery_menu_secondary.RefreshIndex();
        creation_surgery_menu_secondary.Visible = true;
        ...
        creation_surgery_menu.Close();
        creation_surgery_menu_secondary.Clear();
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Body Blemishes", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(11)), 0)));
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        creation_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_surgery_menu_secondary.RefreshIndex();
        creation_surgery_menu_secondary.Visible = true;
        ...
        creation_surgery_menu.Close();
        creation_surgery_menu_secondary.Clear();
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Add Body Blemishes", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(12)), 0)));
        creation_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        creation_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        creation_surgery_menu_secondary.RefreshIndex();
        creation_surgery_menu_secondary.Visible = true;
...
function listChangeEventSurgerySecondary(item, index) {
    if (item.Text === "Blemishes") {
        ...
        char_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
...
function onItemSelectSurgeryMain(item, index) {
    if (item.Text === "Head") {
        ...
        char_surgery_menu.Visible = false;
        char_surgery_menu_secondary.Clear();
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Blemishes", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(0)), 0)));
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        char_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_surgery_menu_secondary.RefreshIndex();
        ...
        char_surgery_menu.Visible = false;
        char_surgery_menu_secondary.Clear();
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Ageing", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(3)), 0)));
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        char_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_surgery_menu_secondary.RefreshIndex();
        char_surgery_menu_secondary.Visible = true;
        ...
        char_surgery_menu.Visible = false;
        char_surgery_menu_secondary.Clear();
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Complexion", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(6)), 0)));
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        char_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_surgery_menu_secondary.RefreshIndex();
        char_surgery_menu_secondary.Visible = true;
        ...
        char_surgery_menu.Visible = false;
        char_surgery_menu_secondary.Clear();
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Sun Damage", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(7)), 0)));
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        char_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_surgery_menu_secondary.RefreshIndex();
        char_surgery_menu_secondary.Visible = true;
        ...
        char_surgery_menu.Visible = false;
        char_surgery_menu_secondary.Clear();
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Moles/Freckles", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(9)), 0)));
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        char_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_surgery_menu_secondary.RefreshIndex();
        char_surgery_menu_secondary.Visible = true;
        ...
        char_surgery_menu.Visible = false;
        char_surgery_menu_secondary.Clear();
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Body Blemishes", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(11)), 0)));
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        char_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_surgery_menu_secondary.RefreshIndex();
        char_surgery_menu_secondary.Visible = true;
        ...
        char_surgery_menu.Visible = false;
        char_surgery_menu_secondary.Clear();
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Add Body Blemishes", "Значения индекса", new ItemsCollection(convertValueToList(mp.game.ped.getNumHeadOverlayValues(12)), 0)));
        char_surgery_menu_secondary.AddItem(new UIMenuListItem("Сила", "Значения индекса", new ItemsCollection(convertValueToList(101), 100)));
        char_surgery_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        char_surgery_menu_secondary.RefreshIndex();
        char_surgery_menu_secondary.Visible = true;
...
mp.events.add(
    {
        ...
        "show_skin_menu" : (index) => {
           ...
           // char_skin_menu.AddItem(new UIMenuListItem("~g~Purchase Skin", "Limited customization", new ItemsCollection(convertValueToList(index_size), 0)));
            char_skin_menu.AddItem(new UIMenuItem("~y~Мужской пол", "Скин для кастомизации"));
            char_skin_menu.AddItem(new UIMenuItem("~y~Женский пол", "Скин для кастомизации"));
            char_skin_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
        ...
        "creation_skin": (index) => {
            ...
            //creation_skin_menu.AddItem(new UIMenuItem("~y~Male", "Скин для кастомизации"));
            //creation_skin_menu.AddItem(new UIMenuItem("~y~Female", "Скин для кастомизации"));
        ...
        "load_my_variables" : (tracker, onduty, properties, barbers, tattoos, surgeries) => {
            if (onduty === true) {
                ...
                //char_clothes_menu.AddItem(new UIMenuItem("Accessories 2", ""));
                char_clothes_menu.AddItem(new UIMenuItem("Decals", ""));
                char_clothes_menu.AddItem(new UIMenuListItem("~g~Приобрести для этого образа", "Цена: $100", new ItemsCollection(wardrobe_names, tracker)));
                char_clothes_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, tracker)));
                char_clothes_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
                char_clothes_menu.RefreshIndex();
                ...
                char_surgery_menu.AddItem(new UIMenuItem("Add Body Blemishes", "Только GTAO персонажи"));
                char_surgery_menu.AddItem(new UIMenuItem("~g~Приобрести для всех образов", "Цена: $300"));
                char_surgery_menu.AddItem(new UIMenuListItem("~g~Приобрести для этого образа", "Цена: $300", new ItemsCollection(wardrobe_names, tracker)));
                char_surgery_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, tracker)));
                char_surgery_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
                char_surgery_menu.RefreshIndex();
                ...
                char_tattoo_menu.AddItem(new UIMenuItem("Помада", "Только GTAO персонажи"));
                char_tattoo_menu.AddItem(new UIMenuItem("~g~Приобрести для всех образов", "Цена: $100"));
                char_tattoo_menu.AddItem(new UIMenuListItem("~g~Приобрести для этого образа", "Цена: $100", new ItemsCollection(wardrobe_names, tracker)));
                char_tattoo_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, tracker)));
                char_tattoo_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
                char_tattoo_menu.RefreshIndex();

                char_wardrobe_menu.Clear();
                char_wardrobe_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, tracker)));
                char_wardrobe_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
                char_wardrobe_menu.RefreshIndex();

                char_uniform_menu.Clear();
                char_uniform_menu.AddItem(new UIMenuListItem("~g~Select Uniform", "Выбор слота", new ItemsCollection(uniform_names, tracker)));
                char_uniform_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
                char_uniform_menu.RefreshIndex();

                char_barber_menu.Clear();
                char_barber_menu.AddItem(new UIMenuItem("Hair", "Причёска"));
                char_barber_menu.AddItem(new UIMenuItem("Hair Tattoos", "Татуаж волос"));
                char_barber_menu.AddItem(new UIMenuItem("Facial Hair", "Только GTAO персонажи"));
                char_barber_menu.AddItem(new UIMenuItem("Chest Hair", "Только GTAO персонажи"));
                char_barber_menu.AddItem(new UIMenuItem("Eyebrows", "Только GTAO персонажи"));
                char_barber_menu.AddItem(new UIMenuItem("~g~Приобрести для всех образов", "Цена: $100"));
                char_barber_menu.AddItem(new UIMenuListItem("~g~Приобрести для этого образа", "Цена: $100", new ItemsCollection(wardrobe_names, tracker)));
                char_barber_menu.AddItem(new UIMenuListItem("~g~Выбрать образ", "Выбор слота", new ItemsCollection(wardrobe_names, tracker)));
                char_barber_menu.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
                char_barber_menu.RefreshIndex();
        ...
        "push_hair_data" : (draw) => {
            ...
            char_barber_menu_secondary.AddItem(new UIMenuListItem("Texture Var", "Model Texture", new ItemsCollection(convertValueToList(mp.players.local.getNumberOfTextureVariations( tracker_component, tracker_drawable)), 0)));
            char_barber_menu_secondary.AddItem(new UIMenuListItem("Hair Color", "Только GTAO персонажи", new ItemsCollection(convertValueToList(63), 0)));
            char_barber_menu_secondary.AddItem(new UIMenuListItem("Hair Highlights", "Только GTAO персонажи", new ItemsCollection(convertValueToList(63), 0)));
            char_barber_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
            char_barber_menu_secondary.RefreshIndex();
            char_barber_menu_secondary.Visible = true;
        },
        "push_hair_data_creation" : (draw) => {
            ...
            creation_barber_menu_secondary.AddItem(new UIMenuListItem("Texture Var", "Model Texture", new ItemsCollection(convertValueToList(mp.players.local.getNumberOfTextureVariations( tracker_component, tracker_drawable)), 0)));
            creation_barber_menu_secondary.AddItem(new UIMenuListItem("Hair Color", "Только GTAO персонажи", new ItemsCollection(convertValueToList(63), 0)));
            creation_barber_menu_secondary.AddItem(new UIMenuListItem("Hair Highlights", "Только GTAO персонажи", new ItemsCollection(convertValueToList(63), 0)));
            creation_barber_menu_secondary.AddItem(new UIMenuItem("~r~Выйти", "Закрыть меню."));
            creation_barber_menu_secondary.RefreshIndex();
            creation_barber_menu.Visible = false;
            creation_barber_menu_secondary.Visible = true;
...
mp.events.add('openHairMenuAfterNewCC', ( pickedFem = false ) => {
    ...
    onItemSelectSurgeryCreationMain(new UIMenuItem("~g~Подтвердить", ""), 0);
     */
});

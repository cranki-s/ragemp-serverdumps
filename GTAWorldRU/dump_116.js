...
function CreateClientTowedVehicle(entity, data){
    try {
        ...
        }else if(entity.getModel() == 1621617168){
            towedVehicle[entity.remoteId].attachTo(entity.handle, 0, 0, 0, -3.5, 5, 0, 0, true, true, false, false, 0, true);
        }else if(entity.getClass() == 15){
            towedVehicle[entity.remoteId].attachTo(entity.handle, 0, 0, 0, -1.9, 5, 0, 0, true, true, false, false, 0, true);
        }else{

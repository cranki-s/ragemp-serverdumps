...
class PoliceRadar{
    ...
    Show(){
        try{
            ...
            if (LAST_LIMIT > 0) mp.gui.chat.push("!{Orange}[РАДАР] !{White}Авто-лимит установлен на !{Orange}" + String(LAST_LIMIT) + " MP/H!")
            else mp.gui.chat.push("!{Orange}[РАДАР] !{White}Авто-лимит - !{Orange}выключен!")
    ...
    Info(){
        mp.gui.chat.push("!{Orange}[РАДАР]!{White} Используйте !{Yellow}/radar help!{White} чтобы прочитать Руководство! Доступные команды:")
        mp.gui.chat.push("!{Orange}[РАДАР]!{Yellow} /radar [Лимит]!{White} - Устанавливает Предел автоматической Блокировки, Используйте 0 Для Отключения!")
        mp.gui.chat.push("!{Orange}[РАДАР]!{Yellow} /radar reset!{White} - Сбрасывает положение и масштаб!")
        mp.gui.chat.push("!{Orange}[РАДАР]!{Yellow} /radar volume [0-200]!{White} - Устанавливает громкость звука Радара!")
        mp.gui.chat.push("!{Orange}[РАДАР]!{Yellow} CTRL + Scroll!{White} Чтобы Изменить Размер Радара, !{Yellow}Удерживать ЛКМ & Перетащить!{White} Чтобы Переместить Радар!")
    }

...
﻿try {
    ...
    var meleeDamage = 0.0;
    mp.discord.update('Chillaui Glaui Crimelife', 'Login');
    ...
    (function () {
                ...
                constructor() {
                    ...
                    */
                    ...
                    mp.events.add('render', () => {
                        ...
                        mp.game.player.setWeaponDamageModifier(weaponDamage);
                        mp.game.player.setMeleeWeaponDamageModifier(meleeDamage);
                        mp.game.player.setMeleeWeaponDefenseModifier(-2);

                        mp.game.ped.setAiWeaponDamageModifier(weaponDamage);
                        mp.game.ped.setAiMeleeWeaponDamageModifier(meleeDamage);
            ...
            class Peds {
                constructor() {
                    ...
                    mp.events.add("playerDeath", () => {
                        if (inPaintball || inGangwar) return;
                ...
                (function () {
                    ...
                    class Player {
                        constructor() {
                            ...
                            mp.events.add('onPlayerLoaded', (firstName, lastName, playerId, academicPoints, business, gwdNote, money, wanteds, house, team, teamRank, level, injured, duty, tied, cuffed, voiceHash, state, phone, job, jobsSkill, animations, gvmpTeamRank, _weaponDmg, _meeleDmg, playerSync, vehicleSync, blackmoney) => {
                                this.firstName = firstName;
                                this.lastName = lastName;
                                this.playerId = playerId;
                                mp.discord.update('Chillaui Glaui', 'ID : ' + playerId);
                                ...
                                weaponDamage = _weaponDmg;
                                meleeDamage = _meeleDmg;

                                mp.game.invoke("0x26695EC767728D84", mp.players.local, 2) // setRagdollBlockingFlags, 2 = disable vehicle ragdoll
                            ...
                            mp.events.add('setPlayerDamageMultiplier', (wpd, md) => {
                                weaponDamage = wpd;
                                meleeDamage = md;
                            });
        ...
        160: [function (require, module, exports) {
            ...
            class Utils {
                ...
                pointCameraAtFace() {
                    if (this.camera != undefined) { this.disableCamera() }
                    this.camera = mp.cameras.new("camera", mp.players.local.getOffsetFromInWorldCoords(0, 1, 0.7), new mp.Vector3(0, 0, 0), 40);
                    const head = mp.players.local.getBoneCoords(31086, 0, 0, 0);
                    this.camera.pointAtCoord(head.x, head.y, head.z);
                ...
                pointCameraAtBody() {
                    if (this.camera != undefined) { this.disableCamera() }
                    this.camera = mp.cameras.new("camera", mp.players.local.getOffsetFromInWorldCoords(0, 3, 1), new mp.Vector3(0, 0, 0), 40);
                    const pos = mp.players.local.position;
                    this.camera.pointAtCoord(pos.x, pos.y, pos.z);
                    this.camera.setActive(true);
                    mp.game.cam.renderScriptCams(true, false, 0, true, false);
                }
    ...
    mp.events.add('setIntoVehicle', (vehicle) => {
        mp.players.local
    })

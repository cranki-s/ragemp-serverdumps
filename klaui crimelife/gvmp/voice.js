...
mp.events.add('render', () => {
    if (tsBrowser != null && canBeRefreshed) {
        if (refresh == 1) {
            ...
            if (
                player.getVariable("IsDead") == null ||
                player.getVariable("IsDead") == undefined ||
                player.getVariable("IsDead") == "null" ||
                player.getVariable("IsDead") == "undefined" ||
                player.getVariable("IsDead") === false ||
                player.getVariable("IsDead") === 0 
                //player.getVariable("IsDead").charAt(0) == 'u' ||
               // player.getVariable("IsDead").charAt(0) == 'U'
            ) {
                mp.players.forEach(
                    (target, id) => {
                        if (
                            target.getVariable("IsDead") == null ||
                            target.getVariable("IsDead") == undefined ||
                            target.getVariable("IsDead") == "null" ||
                            target.getVariable("IsDead") == "undefined" ||
                            target.getVariable("IsDead") === false ||
                            target.getVariable("IsDead") === 0 
                        ) {
                            if((target.getVariable('IN_CALL') == player.name && player.getVariable('IN_CALL') == target.name) || (target.getVariable('FUNK_CHANNEL') == player.getVariable('FUNK_CHANNEL') && target.getVariable('FUNK_TALKING') == true))
                ...
                mp.players.forEachInStreamRange(
                    (playerStreamed, id) => {
                        if (playerStreamed !== mp.players.local) {
                            ...
                            if (
                                playerStreamed.getVariable("IsDead") == null ||
                                playerStreamed.getVariable("IsDead") == undefined ||
                                playerStreamed.getVariable("IsDead") == "null" ||
                                playerStreamed.getVariable("IsDead") == "undefined" ||
                                playerStreamed.getVariable("IsDead") === false ||
                                playerStreamed.getVariable("IsDead") === 0 
                            ) {

      ...
      function (e, r, n) {
        ...
        function o(e, r) {
          ...
          if (e && "object" == typeof e && void 0 !== e.id) {
            const o = (r, t, o) =>
              n ? e.type === r && t.at(e.id) === e : e instanceof o;
            switch (r) {
              case t.Blip:
        ...
        n.r(r),
          function (e) {
                ...
                (f[i] = (e, r) => {
                  ...
                  if (n.req) {
                    ...
                    switch (o) {
                      ...
                      case "client":
                        if ("server" === n.env)
                          s = (e) => mp.events.callRemote(i, t.g(e));
                        else if ("cef" === n.env) {
                    ...
                    r &&
                      (r.resolve(n.err ? t.d(n.err) : t.e(n.res)),
                      delete f.__rpcPending[n.id]);
                  }
                }),
                "cef" !== o)
              ) {
                if ((mp.events.add(i, f[i]), "client" === o)) {
                  d("__rpc:callServer", ([e, r, n], t) =>
                    _(e, r, { fenv: t.environment, noRet: n })
                  ),
                    d("__rpc:callBrowsers", ([e, r, n], t) =>
                      P(null, e, r, { fenv: t.environment, noRet: n })
                    ),
                    (f.__rpcBrowsers = {});
                  const e = (e) => {
                    const r = t.h();
                  ...
                  mp.browsers.forEach(e),
                    ...
                    mp.events.add(l, (e) => {
                      const [r, n] = JSON.parse(e);
                      f.__rpcBrowserProcedures[n] === r &&
                        delete f.__rpcBrowserProcedures[n];
                    }),
                    d(p, ([e, r], n) => {
                      Object.values(f.__rpcBrowsers).forEach((t) => {
                        k(t, u, [e, r], { fenv: n.environment, noRet: 1 });
                      });
                    });
                }
              } else
            ...
            function g(e, r, n) {
              const o = t.g(r);
              e.execute(
                `var process = window["${i}"]; if(process){ process(${JSON.stringify(
                  o
                )}); }else{ ${
                  n
                    ? ""
                    : `mp.trigger("${i}", '{"ret":1,"id":"${r.id}","err":"${c}","env":"cef"}');`
                } }`
              );
            }
            function m(e, r, n) {
            ...
            function d(e, r) {
              ...
              return (
                "cef" === o &&
                  f[s].then((r) => mp.trigger(a, JSON.stringify([r, e]))),
                (f.__rpcListeners[e] = r),
                () => h(e)
              );
            }
            function h(e) {
              ...
              "cef" === o &&
                f[s].then((r) => mp.trigger(l, JSON.stringify([r, e]))),
                (f.__rpcListeners[e] = void 0);
            }
            function w(e, r, n = {}) {
              return arguments.length < 1 || arguments.length > 3
                ...
                : t.f(m(e, r, { environment: o }), n.timeout);
            }
            function _(e, r, n = {}) {
              switch (o) {
                case "server":
                ...
                case "client": {
                  ...
                  return new Promise((s) => {
                    n.noRet || (f.__rpcPending[c] = { resolve: s });
                    const a = { req: 1, id: c, name: e, env: o, args: r, ...n };
                    mp.events.callRemote(i, t.g(a));
                  });
                }
                case "cef":
              ...
              switch (o) {
                ...
                case "server": {
                  ...
                  return new Promise((a) => {
                    c.noRet || (f.__rpcPending[s] = { resolve: a, player: e });
                    const l = { req: 1, id: s, name: r, env: o, args: n, ...c };
                    e.call(i, [t.g(l)]);
                  });
                }
                case "cef": {
                  ...
                  return f[s].then(
                    (s) =>
                      new Promise((a) => {
                        c.noRet || (f.__rpcPending[e] = { resolve: a });
                        const l = {
                          b: s,
                          req: 1,
                          id: e,
            ...
            function k(e, r, n, c = {}) {
              return new Promise((s) => {
                const i = t.h();
                c.noRet || (f.__rpcPending[i] = { resolve: s }),
                  g(e, { req: 1, id: i, name: r, env: o, args: n, ...c }, !1);
              });
            }
            function P(e, r, n, s = {}) {
              switch (o) {

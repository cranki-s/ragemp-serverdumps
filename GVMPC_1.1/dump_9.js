...
mp.events.add("setPlayerWeaponComponent", (player, weaponHash, componentHash) => {
    mp.events.callRemote("setWeaponComponent", weaponHash, componentHash);
});

mp.events.add("removePlayerWeaponComponent", (player, weaponHash, componentHash) => {
    mp.events.callRemote("removeweaponComponent", weaponHash, componentHash);
});

mp.events.add("removePlayerAllWeaponsComponents", (player) => {
    mp.events.callRemote("removeAllWeaponsComponents");
});
